...
//	List<House> findByCityOrType(String city,String type);
	...
	@Query("select e from  Employee e where e.firstName = ?1 or e.lastName = ?1 or e.location = ?1 or e.cell = ?1 or e.id = ?1 or e.designation = ?1 or e.emailId = ?1 or e.skills = ?1")
